 ...
 * 
 * The main interface for building and sending API requests.
 * - Supports Method, URL, Params, Auth, Headers, and Body configuration.
 * - Manages saving/updating requests to Collections.
