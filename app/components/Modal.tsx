...
export default function Modal({ isOpen, onClose, title, children }: ModalProps) {
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 font-sans">
            ...
            <div
                ref={modalRef}
                className="relative w-full max-w-md bg-white border-2 border-blue-500 rounded-2xl shadow-2xl shadow-blue-500/20 overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col"
            >
                {/* Header */}
