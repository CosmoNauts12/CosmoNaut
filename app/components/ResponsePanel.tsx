 ...
 * 
 * Displays the results of an executed API request.
 * - Shows Status, Time, and Size metrics.
 * - Renders JSON response body with syntax highlighting (via simple pre).
 * - Handles various error states (Network, DNS, SSL) with visual feedback.
 */
