 ...
 * 
 * A modal dialog for application-wide configuration.
 * - General settings: Default workspace, confirmation prompts.
 * - Request defaults: Default HTTP method.
 * - Controlled by settings state in SettingsProvider.
 */
